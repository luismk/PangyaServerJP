...
namespace Py_Connector.DataBase
{
    ...
    public partial class PangyaEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<int>> ProcGuildGetList(Nullable<int> pAGE, Nullable<int> tOTAL, string sEARCH)
        {
            var pAGEParameter = pAGE.HasValue ?
                new ObjectParameter("PAGE", pAGE) :
                new ObjectParameter("PAGE", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("ProcGuildGetList", pAGEParameter, tOTALParameter, sEARCHParameter);
        }
